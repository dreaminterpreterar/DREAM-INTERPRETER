    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('dreamInterpreter', () => ({
            ...
            async openAdAndInterpretDream(dream) {
                window.open('https://www.profitableratecpm.com/wqb5ihzu?key=f7b29e333a968d102e73df6c085357ac', '_blank');
                await this.interpretDream(dream);
            },
